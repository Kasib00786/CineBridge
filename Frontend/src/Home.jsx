...
export default function Home() {
  ...
  const movies = [
    { name: "The Woman in the Yard", category: "Sci-Fi", image: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQ-OF_KR1mQgvVfISUApdtofD03aCIAdi2Oi-jhk3k-7ooX2cGy" },
    { name: "Jolly LLB 3", category: "Adventure", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvs9Pyu6rsIuNlGUMc2w5fYvJhag-YY_dTgMyOu2JNC8zNhxOPfHn7UyUGaencsJazsu0q&s=10" },
    ...
    { name: "Zootopia 2", category: "Fantasy", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqU-w52lblFgRaE9zJo5hubrfeyRK-O9hkv6pbSQYKoqzmKEupxh9SoPGt2KvwcjuTgO-v&s=10" },
    { name: "Titanic", category: "Romance", image: "https://m.media-amazon.com/images/I/71rNJQ2g-EL._AC_SL1500_.jpg" },
    { name: "Border 2", category: "Superhero", image: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQB82otQXZxrK-cwuKI-iD0XHwbyXRY0OvCZ76HKoN-LWMgiGUM" },
            ...
            filteredMovies.map((movie, index) => (
              ...
              >
                ...
                <div className="p-3 text-center">
                  ...
                  <Link to="/booknow"><button className="mt-3 bg-yellow-500 text-black font-medium px-4 py-2 rounded-lg w-full">
                    Book Now
                  </button></Link>
                </div>
              </motion.div>
